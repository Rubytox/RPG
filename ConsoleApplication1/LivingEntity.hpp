...
public:
	...
	LivingEntity(int PV, int maxPV, int degatsDeBase, int niveau, std::string m_nom, Element element); // Constructeur << complet >>
...
protected:
	...
	int m_max_PV;
	Element m_element; // Indique l'éléement de l'entité
